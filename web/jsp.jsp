 ...
 <%            
     ...
     //fillo now
       String name = (String)request.getAttribute("name");
        ...
        Fillo fillo=new Fillo();
           Connection connection=fillo.getConnection("C:\\Users\\ABHIJITH VELAGA\\Desktop\\jyothi\\Book1.xlsx");
  ...
  PrintWriter pw = null;
    try {
        fw = new FileWriter("C:\\Users\\ABHIJITH VELAGA\\Desktop\\jyothi\\append.txt",true);
