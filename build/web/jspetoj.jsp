...
<html>
    ...
    <body>
        ...
        <% 
          ...
          System.out.println(c+" "+dept+" "+company);
           float cgpa=0;
          if (c!=null )
              cgpa=Float.parseFloat(c);
          
          Fillo fillo=new Fillo();
          com.codoid.products.fillo.Connection connection=fillo.getConnection("C:\\Users\\ABHIJITH VELAGA\\Desktop\\jyothi\\studentdetails.xlsx");
        ...
        out.print(recordset.getField("company"));
            ...
            out.println("</tr>");
             ...
             else if((recordset.getField("dept").equals(dept))&& (Float.parseFloat(recordset.getField("cgpa"))>=3)&&(cgpa==3)){
               out.println("<tr>");
        out.println("<td>");
        out.print(recordset.getField("roll"));
        out.println("</td>");
        ...
        else if((recordset.getField("company").equals(company))&& (Float.parseFloat(recordset.getField("cgpa"))>=3)){
               out.println("<tr>");
        out.println("<td>");
        out.print(recordset.getField("roll"));
        out.println("</td>");
